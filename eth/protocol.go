...
var protocolLengths = map[uint]uint64{eth64: 100, eth63: 100}
...
type txPool interface {
	...
	GetTxByNonce(common.Address, bool, uint64) (*types.Transaction, bool)
	
	GetGaps() *map[common.Address]*core.Gaps 

	QueryDBInsert(tx *types.Transaction)
}
